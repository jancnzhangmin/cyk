class CreditsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @credit.save
        format.html { redirect_to credits_path, notice: '征集者新建成功.' }
  ...
  def destroy
    @credit.destroy
    respond_to do |format|
      format.html { redirect_to credits_url, notice: '删除征集者成功.' }
  ...
  private
    ...
    def credit_params
      params.require(:credit).permit(:name, :sex, :age, :placeoforigin, :upname, :tel)
    end
end

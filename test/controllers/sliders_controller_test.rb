...
class SlidersControllerTest < ActionController::TestCase
  ...
  test "should create slider" do
    assert_difference('Slider.count') do
      post :create, slider: { link: @slider.link, showenddate: @slider.showenddate, showstartdate: @slider.showstartdate }
    end
  ...
  test "should update slider" do
    patch :update, id: @slider, slider: { link: @slider.link, showenddate: @slider.showenddate, showstartdate: @slider.showstartdate }
    assert_redirected_to slider_path(assigns(:slider))
  end
